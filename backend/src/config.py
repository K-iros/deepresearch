...
def _normalize_env_value(value: Any) -> Any:
    """Normalize common string env formats such as quoted values."""
    ...
    def from_env(cls, overrides: Optional[dict[str, Any]] = None) -> "Configuration":
        ...
        for field_name in cls.model_fields.keys():
            ...
            if env_key in os.environ:
                raw_values[field_name] = _normalize_env_value(os.environ[env_key])
        ...
        for key, value in env_aliases.items():
            if value is not None:
                raw_values.setdefault(key, _normalize_env_value(value))
